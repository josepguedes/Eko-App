...
export async function initializeDefaultGroups(): Promise<void> {
    ...
    const defaultGroups = [
        new Group(
            ...
            50,
            'Public',
            ['default_1', 'default_2', 'default_3', 'default_7'],
            new Date('2024-01-01')
        ),
        new Group(
            '2',
        ...
        new Group(
            ...
            60,
            'Public',
            ['default_8', 'default_9', 'default_10', 'default_11', 'default_12'],
            new Date('2024-02-01')
        ),
        new Group(
            '4',
        ...
        new Group(
            ...
            50,
            'Public',
            ['default_3', 'default_6', 'default_10'],
            new Date('2024-03-15')
        ),
    ];
